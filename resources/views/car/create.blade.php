                    ...
                    <form method="POST" action="/car">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="model" name="model" class="form-control @error('model') is-invalid @enderror"
                                    type="text" placeholder="{{__('Car model')}}" value="{{ old('model') }}" required>
                                @error('model')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="constructor" name="constructor"
                                    ...
                                    placeholder="{{__('Car constructor')}}" value="{{ old('constructor') }}" required>
                                @error('constructor')
                                <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="category" name="category"
                                    ...
                                    placeholder="{{__('Car category')}}" value="{{ old('category') }}" required>
                                @error('category')
                                <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <!-- Back button -->
                                <a href="/car" class="btn btn-primary btn-lg mr-3"><i class="fa fa-arrow-left"></i></a>
                                <!-- Submit button -->
